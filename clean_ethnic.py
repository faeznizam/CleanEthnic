...
def categorize_ethnic(name, ethnicity_mapping):
...
def main():
   ...
   # file name
   file_name = 'Donor Without Ethnic.xlsx'
   ...
   ethnicity_mapping = {
    'Chinese': {'lee', 'tan', 'lim', 'wong', 'ng', 'yee', 'chin', 'ling', 'chan', 'chong', 'wei', 'hui',
                ...
                'chieng', 'raymond', 'hiew', 'eunice', 'cheang', 'mah', 'mong', 'kun', 'mary', 'leow', 'lih',
    ...
    'Malay': {'ahmad','abdul','abdullah','zurina', 'mohd', 'bin', 'binti', 'muhammad', 'mohamed', 'mohamad',
              ...
              'nurhasikin','syahiratul','norhairul','baharudin','zulkiffli','nooraihan','zainuddin','nursafira','kamardin'},
    ...
    'Indian': {'a/l', 'a/p','rajandran', 'subramaniam','kumar','krishnan', 'devi', 'raja', 'singh', 'muniandy', 'raman', 'nair', 'rao',
               ...
               'yaashdave','arulmozhi','sagadevan','jeyamaran','rengasamy','ilavarasi','thiriidev','prashanth','rajkumar','karthiga','vasanthi'},
    ...
    'Others': {'john', 'james', 'emily', 'family', 'edward', 'grace', 'rachel', 'david', 'audrey', 'gomes', 'florance', 'nyihin',
               ...
               'nageiswery','jessamine','chrizelda','frederick','sherlynee','jessindra','nattawin','swatheka','florence','jennifer','wazooski'},
}
   
   df['Ethnic'] = df['Full Name'].apply(lambda x: categorize_ethnic(x, ethnicity_mapping))

   df = check_progress(df)

   # rename file with new name
   new_file_name = 'Donor Without Ethnic - Edited.xlsx'
